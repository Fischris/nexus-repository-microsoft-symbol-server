 ...
 */
@Facet.Exposed
public interface MicrosoftSymbolServerContentFacet
        extends Facet
{
    @Nullable
    Content get(String path) throws IOException;
    Content put(String path, Payload content, @Nullable Parameters parameters) throws IOException, ParseException;
}